...
## 3.4.5 - 2025-11-18
### Fixed
- Call to Jira to create comment now uses correct case for 'type' field in 'visibility' (for versions 3.9.x of SCM-Manager or newer)

## 3.4.4 - 2025-11-18
### Fixed
- Call to Jira to create comment now uses correct case for 'type' field in 'visibility' (for versions 3.7.x of SCM-Manager)
