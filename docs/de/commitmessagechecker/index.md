...
liefert das Jira-Plugin einen eigenen Validator für Commit-Nachrichten. Dieser Validator kann bei der Commitnachricht-Validierung konfiguriert werden.

# Validatorkonfiguration
Der Jira-Ticketschlüssel-Validator überprüft sämtliche neuen Commits auf gültige Ticketschlüssel. 
...
![Issue-Schlüssel-Validator](assets/validator.png)
