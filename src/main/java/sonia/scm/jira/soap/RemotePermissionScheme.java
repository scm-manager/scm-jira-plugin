...
public class RemotePermissionScheme  extends sonia.scm.jira.soap.RemoteScheme  implements java.io.Serializable {
    private sonia.scm.jira.soap.RemotePermissionMapping[] permissionMappings;
    ...
    public RemotePermissionScheme(
           ...
           sonia.scm.jira.soap.RemotePermissionMapping[] permissionMappings) {
        super(
            description,
            id,
            name,
     ...
     */
    public sonia.scm.jira.soap.RemotePermissionMapping[] getPermissionMappings() {
        return permissionMappings;
    }
     ...
     */
    public void setPermissionMappings(sonia.scm.jira.soap.RemotePermissionMapping[] permissionMappings) {
        this.permissionMappings = permissionMappings;
    }
