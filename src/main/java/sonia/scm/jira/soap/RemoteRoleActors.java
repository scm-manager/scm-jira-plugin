...
public class RemoteRoleActors  implements java.io.Serializable {
    private sonia.scm.jira.soap.RemoteProjectRole projectRole;

    private sonia.scm.jira.soap.RemoteRoleActor[] roleActors;

    private sonia.scm.jira.soap.RemoteUser[] users;

    public RemoteRoleActors() {
    }

    public RemoteRoleActors(
           sonia.scm.jira.soap.RemoteProjectRole projectRole,
           sonia.scm.jira.soap.RemoteRoleActor[] roleActors,
           sonia.scm.jira.soap.RemoteUser[] users) {
     ...
     * @return projectRole
     */
    public sonia.scm.jira.soap.RemoteProjectRole getProjectRole() {
        return projectRole;
    }
     ...
     * @param projectRole
     */
    public void setProjectRole(sonia.scm.jira.soap.RemoteProjectRole projectRole) {
        this.projectRole = projectRole;
    }
     ...
     * @return roleActors
     */
    public sonia.scm.jira.soap.RemoteRoleActor[] getRoleActors() {
        return roleActors;
    }
     ...
     * @param roleActors
     */
    public void setRoleActors(sonia.scm.jira.soap.RemoteRoleActor[] roleActors) {
        this.roleActors = roleActors;
    }
     ...
     * @return users
     */
    public sonia.scm.jira.soap.RemoteUser[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(sonia.scm.jira.soap.RemoteUser[] users) {
        this.users = users;
    }
