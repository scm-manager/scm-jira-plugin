...
public class RemotePermissionMapping  implements java.io.Serializable {
    private sonia.scm.jira.soap.RemotePermission permission;

    private sonia.scm.jira.soap.RemoteEntity[] remoteEntities;

    public RemotePermissionMapping() {
    }

    public RemotePermissionMapping(
           sonia.scm.jira.soap.RemotePermission permission,
           sonia.scm.jira.soap.RemoteEntity[] remoteEntities) {
     ...
     * @return permission
     */
    public sonia.scm.jira.soap.RemotePermission getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(sonia.scm.jira.soap.RemotePermission permission) {
        this.permission = permission;
    }
     ...
     */
    public sonia.scm.jira.soap.RemoteEntity[] getRemoteEntities() {
        return remoteEntities;
    }
     ...
     */
    public void setRemoteEntities(sonia.scm.jira.soap.RemoteEntity[] remoteEntities) {
        this.remoteEntities = remoteEntities;
    }
