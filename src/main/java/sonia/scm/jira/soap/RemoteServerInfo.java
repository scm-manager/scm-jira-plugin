...
public class RemoteServerInfo  implements java.io.Serializable {
    ...
    private sonia.scm.jira.soap.RemoteTimeInfo serverTime;
    ...
    public RemoteServerInfo(
           ...
           sonia.scm.jira.soap.RemoteTimeInfo serverTime,
     ...
     * @return serverTime
     */
    public sonia.scm.jira.soap.RemoteTimeInfo getServerTime() {
        return serverTime;
    }
     ...
     * @param serverTime
     */
    public void setServerTime(sonia.scm.jira.soap.RemoteTimeInfo serverTime) {
        this.serverTime = serverTime;
    }
