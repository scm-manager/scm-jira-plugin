...
public class RemoteProjectRoleActors  extends sonia.scm.jira.soap.RemoteRoleActors  implements java.io.Serializable {
    private sonia.scm.jira.soap.RemoteProject project;
    ...
    public RemoteProjectRoleActors(
           ...
           sonia.scm.jira.soap.RemoteProject project) {
        super(
            projectRole,
            roleActors,
            users);
     ...
     * @return project
     */
    public sonia.scm.jira.soap.RemoteProject getProject() {
        return project;
    }
     ...
     * @param project
     */
    public void setProject(sonia.scm.jira.soap.RemoteProject project) {
        this.project = project;
    }
